<?php
  ...
  if( isset($_SESSION['Account_username']) AND !empty($_SESSION['Account_password'])):
    ...
    $uid = $_GET['p_code'];
    $stmt = $dbh->prepare("SELECT * FROM `petition`WHERE p_code = $uid");
    $stmt->execute();
  ...
  <body>
    ...
    <div class="container">
      <div class="shadow-lg p-3 mb-5 bg-white rounded">
        <h2 style="text-align:center;">รายละเอียดข้อมูลการรับเงิน</h2><br>
        <div class="container">
          <div class="row">
            <div class="col-2"></div>
            <div class="col-8">
              <form method="post" action="update_hry_process.php" name='form1' class="needs-validation" novalidate>
                <div class="form-row">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md">
                    ...
                    <input type="date" minlength="8" maxlength="50" class="form-control" maxlength="20" id="username" value="<?=date('Y-m-03',strtotime("+1 Month")) ?>" name="p_date_approve2" required >
                ...
                <div class="float-sm-right">
                  <div class="form-row">
                    <div class="form-group">
                      <button type="submit" class="btn btn-success" name="submit" value="Edit Now" onclick="if(confirm('ยืนยันการจ่ายเงินให้ผู้กู้ ยืนยัน?')) return true; else return false;">บันทึก</button>
