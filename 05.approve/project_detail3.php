...
<html lang="en">
  ...
  <body>
    ...
    <div class="shadow-lg p-3 mb-5 bg-white rounded" id="admin">
        ...
        <form method="post" action="update_project_process3.php" name='form1' class="needs-validation" novalidate>
        ...
        <button type="submit" class="btn btn-success" name="submit" value="Edit Now" 
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a class="btn btn-danger" href="\tot\05.approve\index_approve.php" role="button" 
