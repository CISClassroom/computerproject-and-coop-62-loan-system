<?php
 ...
 if( isset($_SESSION['approve_username']) AND !empty($_SESSION['approve_password'])):
   ...
   $sql_1 = "SELECT * FROM `petition` WHERE p_status = 'ค้างชำระ' AND NOT p_position = 'CallCenter' ORDER BY p_code ASC";
   $stmt_1 = $dbh->prepare($sql_1);

   $count1 = "SELECT count(*) FROM `petition` WHERE p_status ='ค้างชำระ' AND NOT p_position = 'CallCenter' ";
