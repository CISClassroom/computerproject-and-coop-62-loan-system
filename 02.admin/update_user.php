  ...
  <body>
    ...
    <div class="container">
      <div class="shadow-lg p-3 mb-5 bg-white rounded">
        <h2 style="text-align:center;">แก้ไขข้อมูลพนักงาน</h2><br>
        <div class="container">
          <div class="row">
            <div class="col-2"></div>
            <div class="col-8">
              <form method="post" action="update_user_process.php" name='form1' class="needs-validation" novalidate>
                <div class="form-row">
                  ...
                  <div class="form-group ">
                    ...
                    <input type="text" minlength="7" maxlength="7" class="form-control" id="code" placeholder="กรอกรหัสพนักงาน" value="<?php echo $row['Personnel_code'] ?>" name="code" required readonly>
                ...
                <div class="form-row">
                  <div class="form-group col-md">
                    ...
                    <select id="position" class="form-control selectpicker" data-live-search="true" name="position" required>
                      <option <?php if ($row['Personnel_Position'] == 'CallCenter') echo 'selected="selected"'; ?> >CallCenter</option>
                      <option <?php if ($row['Personnel_Position'] == 'HelpDesk') echo 'selected="selected"'; ?> >HelpDesk</option>
                      <option <?php if ($row['Personnel_Position'] == 'Supervisor') echo 'selected="selected"'; ?> >Supervisor</option>
                    </select>
                    <div class="invalid-feedback">
                      กรุณาระบุตำแหน่ง!
                    </div>
                  ...
                  <div class="form-group col-md">
                    ...
                    <input type="text" minlength="10" maxlength="10" class="form-control" id="tell" placeholder="กรอกเบอร์โทรศัพท์" value="<?php echo $row['Personnel_Phone'] ?>" name="tell"  required readonly>
                    <div class="invalid-feedback">
                ...
                <div class="form-row">
                  <div class="form-group col-md">
                    ...
                    <input type="text" minlength="6" maxlength="50" class="form-control" maxlength="20" id="username" placeholder="กรอกชื่อผู้ใช้ (username)" value="<?php echo $row['Personnel_Usermae'] ?>" name="username" required readonly>
                    <div class="invalid-feedback">
                  ...
                  <div class="form-group col-md">
                    ...
                    <input type="password" minlength="6" maxlength="20" class="form-control" id="password1" placeholder="รหัสผ่าน" value="<?php echo $row['Personnel_Password'] ?>" name="password1" required readonly>
                    <div class="invalid-feedback">
                  ...
                  <div class="form-group col-md">
                    ...
                    <input type="password" minlength="6" maxlength="20" class="form-control" id="password2" placeholder="ยืนยันรหัสผ่าน" value="<?php echo $row['Personnel_Password'] ?>" name="password2" required readonly>
                    <div class="invalid-feedback">
