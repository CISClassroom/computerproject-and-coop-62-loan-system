...
<html lang="en">
  ...
  <body>
    ...
    <div class="shadow-lg p-3 mb-5 bg-white rounded" id="admin">
        ...
        <form method="post" action="update_faculty_plan_officer_process.php" name='form1' class="needs-validation" novalidate>
        ...
        <input type="hidden"  name="p_code"  id="p_code" value="<?php echo $row['p_code']; ?>"readonly/>
        <div class="text-left">
        ...
        <b>ข้อ 1.</b> ผู้กู้ได้กู้ยืมเงิน เป็นจำนวนเงิน : <?php echo $row['p_amount']; ?>&ensp; บาท
	      ...
	      <div class="text-right">
        <p><span style="padding-right:30px">ลงชื่อ : <img src="..\signature\sign_image\<?php echo $row['p_signature'] ?>" width="170" alt="">
        ...
        <div class="text-center">
            ...
            onclick="if(confirm('ต้องการยกเลิก?')) return true; else return false;">ย้อนกลับ
            </a>
            </div>
            </div>
            </div>
