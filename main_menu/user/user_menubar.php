...
style="background-color: #8B8970;">
    <a class="navbar-brand text-warning" href="\tot\06.employer\index.php">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent"> <!-- เอาไว้ใส่เมนูบาร์ -->
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="\tot\06.employer\callcenter_profile.php">
       ...
       <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span class="glyphicon glyphicon-hand-right" aria-hidden="true"></span> สัญญากู้ยืมเงิน    
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        <a class="dropdown-item" href="\tot\06.employer\insert_form_callcenter.php?Personnel_code=<?php echo $SA;?>">
            <span class="glyphicon glyphicon-book" aria-hidden="true"></span> แบบฟอร์มสัญญากู้ยืมเงิน
          </a>
          <a class="dropdown-item" href="\tot\06.employer\index.php">
            <span class="glyphicon glyphicon-book" aria-hidden="true"></span> ประวัติการกู้ยืม
          </a>
        </div>
       </li>
      </ul>
